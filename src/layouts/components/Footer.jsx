      ...
      <div style={footer}>
        <Box px={4} py={2} backgroundColor="#439D72">
          <Grid gridTemplateColumns="auto 180px" gridGap="2.5%">
            ...
            >
              <Button variant="error">Provide Feedback</Button>
            </a>
          </Grid>
        </Box>
        <Box p={4} backgroundColor="#1E2033">
          <Grid gridTemplateColumns="auto 180px 180px" gridGap="2.5%">
            <div>
              <a target="_blank" rel="noopener noreferrer" href="https://xalgorithms.org/">
                <Text color="oline">Xalgorithms Foundation</Text>
              </a>
            </div>
            <div>
              <Text color="oline">Privacy Policy</Text>
              <Text color="oline">Terms of Service</Text>
            </div>
            <div>
              <a
                target="_blank"
              ...
              >
                <Text color="oline">Source Code</Text>
              </a>
              <a
                target="_blank"
                rel="noopener noreferrer"
              ...
              >
                <Text color="oline">Developer Docs</Text>
              </a>
            </div>
          </Grid>
          <Box p={4}></Box>
        ...
        <div style={cc}>
          <Grid gridTemplateColumns="auto 180px" gridGap="2.5%">
            <p style={smalltext}>CC BY-SA 4.0 2020 Xalgorithms Foundation</p>
            <p style={smalltext}>
